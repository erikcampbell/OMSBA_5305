...
Another method to review data variance by month.
...
# Fit model ARMA(2,0,2) https://stats.stackexchange.com/questions/32634/difference-time-series-before-arima-or-within-arima
```{r, echo=FALSE}
...
ma2_AR2 = 1 - (1-ma1_R2)*(n-1)/(n-2-1) #  0.9605079
...
MAKE A COMMENT COMPARING MODELS
...
arma112_AR2 = 1 - (1-ma1_R2)*(n-1)/(n-2-1) # 0.9605079 
...
arma211_AR2 = 1 - (1-ma1_R2)*(n-1)/(n-2-1) # 0.9605059 
