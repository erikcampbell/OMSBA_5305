...
working_hours <- working_hours %>%
  mutate(observation_date = format(as.Date(observation_date),"%Y-%m"))
...
plot(decomp_work_hours_ts$trend)
plot(decomp_work_hours_ts$seasonal)
plot(decomp_work_hours_ts$random)
```
