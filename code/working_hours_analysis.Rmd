...
QUESTIONS:
Test our models on last 6 observations in data set as part of our forecast and evaluating fit, then provide a forecast?  We didn't do that to see realized values as part of forecast.
...
fixed_fcast_ar3 <- dynlm(working_hours_diff ~ stats::lag(working_hours_diff,-1) + stats::lag(working_hours_diff,-3), # AR 3 process
