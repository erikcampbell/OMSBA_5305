...
TO DO:
1. Finish OLS-weighted optimal forecast - emulate talbe 9.8 on text pp.245
2. Check IET Test t-values
3. Evaluate Homoskedasticity/Heteroscedasticity of regressions?
...
## Creat First Difference Time Series, Conduct EDA and Evaluate Stationarity
```{r}
# create First Difference of Hours Worked Index
working_hours_diff = diff(working_hours_ts)
