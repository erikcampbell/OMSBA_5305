...
fcast1 <- forecast(arma212_train, h = 1) # 107.9134
#         Point Forecast   
#Jul 2021       107.9134    
...
check_res(arma212_forecast) # interactive chart
...
datatable(errors_arma212, filter = "top", options = list(pageLength = nrow(errors_arma212), autoWidth = TRUE))
```
...
ar2_dynlm <- cbind(test,fcast2, ferror2, loss2)
...
plot(test_df, main = "Simple Naive Last 4 Observations Predicted Vs. Actual", 
     type = "l", col = "1", xlab = "Date", ylab = "Working Hours Index",
     lwd = 2)
lines(simple_naive_4, col = "2", lwd = 2)
lines(arma212_predict, col = "3", lwd = 2)
lines(arma210_predict, col = "4", lwd = 2)
lines(arma012_predict, col = "5", lwd = 2)
legend("bottomright",          
       c("Actual", "Simple Naive 4", "Arma(2,2)", "AR(2)", "MA(2)"),
       lty = 1,
       col = 1,2,3,4,5)
```
