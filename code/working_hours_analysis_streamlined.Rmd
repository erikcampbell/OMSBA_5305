...
stats_year_base
```
This chart looks at the variance in index of hours worked by year from 2006-2023 and can shed some insight about cycles in working hours.
...
Variance in index of hours worked by month from 2006-2023 and can shed some insight about cycles in working hours.
...
```
This boxplot is another method to look at potential seasonality by month from 2006-2023. The Q1 and Q4 are slightly higher than Q2 and Q3 as present in the box plot which is indicative of a cycle. First let's address the Trend and maybe the seaonsality with taking the first difference. It is clearly evident that taking the first-difference of hours worked index is warranted.
...
summary(model_arma2112_estimate)
summary(fcast1) # RMSE = 1.334011 , MAE = .4598895
...
summary(model_arma210_estimate)
summary(fcast2) # RMSE = 1.60545 , MAE = 0.5050574
...
# Coefficients:
#                        (Intercept)  stats::lag(working_hours_diff, -1)  stats::lag(working_hours_diff, -2)  
#                            0.06365                            -0.02819                            -0.16351   
